const We = () =>{
   return (
      <div id="We" className="flex flex-col gap-20">
         ...
         <p className="text-lg font-extralight">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Reprehenderit accusamus in dolor. Mollitia quidem distinctio ex autem quisquam provident illo numquam molestias? Minima, sapiente porro. Adipisci dolores debitis nihil voluptates.
