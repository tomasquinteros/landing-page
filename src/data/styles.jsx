const stylesNavBar = {
   styleNav: "p-8 flex justify-between lg:justify-around fixed items-center transition duration-300 all z-40 top-0 left-0 min-w-full",
   active: "bg-black",
