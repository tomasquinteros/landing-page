...
const Form = () =>{ 
   ...
   return (
      <div>
         <div>
            <form id="form" onSubmit={handleSubmit((data) => console.log(data))} className="p-4">
               ...
               <ul className="flex flex-col gap-4">
                  <li className="flex flex-col gap-1 w-full">
                     <label className="text-lg text-cyan-300 font-medium">Name</label>
                     <input className="bg-transparent border border-cyan-400 p-2 text-white" type="text" 
                        {...register( "Name",
                              {
                  ...
                  <li className="flex flex-col gap-1 w-full">
                     <label className="text-lg text-cyan-300 font-medium">Email</label>
                     <input className="bg-transparent border border-cyan-400 p-2 text-white" type="email" 
                  ...
                  <li className="flex flex-col gap-1 w-full">
                     <label className="text-lg text-cyan-300 font-medium">Message</label>
         ...
         { send & completed() ? 
            <div className="z-50 fixed bg-black/95 top-0 left-0 w-screen h-screen flex justify-center items-center">
               <div className="bg-gray-400/50 p-4 flex flex-col gap-8 rounded-md">
                  <Send/>
